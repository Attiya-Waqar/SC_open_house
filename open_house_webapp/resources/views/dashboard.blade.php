...
@section('content')
    ...
    <div class="container p-3 mb-5"style="">  
        ...
        <div class="d-flex text-center container">
            @for ($j=0; $j<7; $j++)
               <div class="d-flex justify-content-center align-items-center container m-2 p-0" style="width:12vw; height:10vh; box-shadow: 0px 0px 0px lightgrey; border-radius: 1rem; background-color: lightgrey; color:#47a19f; font-weight: 1000; border:0.65px solid #47a19f; text-overflow: ellipsis;">
                    <div>
